...
5. Rode todos os scripts ou apenas células específicas. Bibliotecas e dependências são instaladas na seção de 'Instalação de Dependências e Carregamento de Dataset'
